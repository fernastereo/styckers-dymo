  ...
  <div className="flex items-center justify-between">
    <div className="flex items-center space-x-2">
      ...
      <div v-if="showDescription" className="ml-6 flex items-center gap-4">
        <label :htmlFor="descripcion" className="block text-xs font-medium text-foreground">
          Descripción:
        </label>
        <input 
          id="descripcion"
          ...
          className="max-w-md px-3 py-0.5 bg-background border border-gray-300 rounded-md placeholder:text-gray-400 focus-visible:outline-indigo-600 sm:text-sm"
          v-model="descripcion"
        />
      </div>
    </div>
    <div className="ml-6 flex items-center gap-4">
        <label :htmlFor="titulo" className="block text-xs font-medium text-foreground">
          Número de Planos
        </label>
        <input 
          id="numPlanos"
          ...
          min="0"
          placeholder="0"
          className="max-w-20 px-3 py-0.5 bg-background border border-gray-300 rounded-md placeholder:text-gray-400 focus-visible:outline-indigo-600 sm:text-sm"
